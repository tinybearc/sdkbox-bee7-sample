...
public class DemoPlayer implements ExoPlayer.Listener, ChunkSampleSource.EventListener,
    ...
    public DemoPlayer(RendererBuilder rendererBuilder, GameWallConfiguration.VideoPrequalGlobalConfig videoPrequalGlobalConfig, boolean audioMute) {
        this.rendererBuilder = rendererBuilder;
        this.audioMute = audioMute;
        player = ExoPlayer.Factory.newInstance(RENDERER_COUNT, videoPrequalGlobalConfig.getMinBufferMillis(), videoPrequalGlobalConfig.getMinRebufferMillis());
