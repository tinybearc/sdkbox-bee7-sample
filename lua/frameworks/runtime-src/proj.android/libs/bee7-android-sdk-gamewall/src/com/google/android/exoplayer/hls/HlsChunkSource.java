...
public class HlsChunkSource {
   ...
   */
  //public static final long DEFAULT_MIN_BUFFER_TO_SWITCH_UP_MS = 2000;
  ...
  public HlsChunkSource(DataSource dataSource, String playlistUrl, HlsPlaylist playlist,
      ...
      AudioCapabilities audioCapabilities, GameWallConfiguration.VideoPrequalGlobalConfig videoPrequalGlobalConfig) {
    this(dataSource, playlistUrl, playlist, bandwidthMeter, variantIndices, adaptiveMode,
        videoPrequalGlobalConfig.getMinBufferToSwitchUpMillis(), videoPrequalGlobalConfig.getMaxBufferToSwitchDownMillis(),
        audioCapabilities);
  }
